...
export default class FollowAndFollowersCard extends BindingClass {
    constructor() {
      ...
      const methodsToBind = ['userSocialInformation', 'createUserCard', 'createInputField'];
    ...
    async userSocialInformation() {
      const userProfileContainer = document.getElementById('follows-and-followers-container');
